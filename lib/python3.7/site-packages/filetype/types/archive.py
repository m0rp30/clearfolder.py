...
class Crx(Type):
    ...
    """
    MIME = 'arcive/x-google-chrome-extension'
    EXTENSION = 'crx'
...
class Cab(Type):
    ...
    """
    MIME = 'arcive/vnd.ms-cab-compressed'
    EXTENSION = 'cab'
